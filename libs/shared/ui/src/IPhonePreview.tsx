...
function ChannelIcon({
  ...
  if (channel === 'Wallet') {
    return (
      <span className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-white text-[10px] font-bold text-[var(--onda-primary-500)]">
        {logoUrl ? (
    ...
    >
      ...
      {stripImageUrl ? (
        ...
        <img
          src={stripImageUrl}
          alt=""
          className="mt-1.5 aspect-[3/1] w-full max-h-14 object-cover"
        />
      ) : null}
            ...
            return (
              ...
              >
                <div className="flex items-start gap-2">
                  <ChannelIcon channel={item.channel} logoUrl={logoUrl} />
                  <div className="min-w-0 flex-1">
