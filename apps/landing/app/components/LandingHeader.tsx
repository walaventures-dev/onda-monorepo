...
import { demoUrl, loginUrl, onboardingUrl, SHOW_POS_LANDING } from '../lib/pricing';
    ...
    >
      <div className="relative mx-auto flex max-w-6xl items-center justify-between gap-3 px-6 py-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            href={demoUrl()}
            className="hidden rounded-full px-3.5 py-2.5 text-sm font-semibold text-[var(--onda-primary-500)] transition hover:bg-[var(--onda-primary-50)] lg:inline-flex"
          >
            Pedir demo
          </a>
          <a
        ...
        {menuOpen ? (
          <div className="absolute inset-x-4 top-full z-50 rounded-2xl border border-[var(--onda-border)] bg-[var(--onda-card)] p-4 shadow-lg md:hidden">
            ...
            <a
              href={demoUrl()}
              className="mt-2 flex w-full items-center justify-center rounded-full border border-[var(--onda-border)] bg-[var(--onda-card)] px-4 py-3 text-sm font-semibold text-[var(--onda-primary-500)]"
              onClick={() => setMenuOpen(false)}
            >
              Pedir un demo
            </a>
